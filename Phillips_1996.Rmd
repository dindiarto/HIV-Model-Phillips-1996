...
𝑝: fraction of infected CD4+ cells that are latently infected (unitless, 1≥𝑝≥0). 𝛼: rate that latent CD4+   cells become activated (1/time, 𝛼≥0).  
...
$$\frac{dL(t)}{dt} = \rho \beta V(t)R(t) - \mu L(t) - \beta V(t)R(t),$$
